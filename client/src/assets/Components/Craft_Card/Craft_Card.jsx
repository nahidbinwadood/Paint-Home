...
const Craft_Card = ({craft_item}) => {

    const{_id,itemName,subcategoryName, price,rating,stockStatus, image,description}=craft_item;
    return (
        <div
        data-aos="fade-up"
        ...
        <div className="flex flex-col gap-4 lg:gap-0 md:flex-row md:justify-between px-2 text-[#878787] t">
          ...
          <div className="flex lg:items-center lg:justify-center gap-2  ">
            <h3 className=" font-semibold ">
              Stock Status : <span className="text-red-400">{stockStatus}</span>
            </h3>
          </div>
        </div>
...
Craft_Card.propTypes = {
    craft_item: PropTypes.object.isRequired,
  };
export default Craft_Card;