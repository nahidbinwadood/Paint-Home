              ...
              <div className="flex flex-col justify-between lg:py-5">
                <div>
                  <h2 className="text-3xl font-bold leading-tight text-white m:text-4xl lg:leading-tight lg:text-5xl">
                    It’s time to draw something exciting!
                  </h2>
                  <p className="max-w-xl text-white mx-auto mt-4 text-base leading-relaxed ">
                    We are giving some of best types of arts and Drawing in all over the world.You
                    can idea and see any types of arts you like.
                  </p>
                ...
                <div className="hidden md:mt-auto md:block">
                  ...
                  <blockquote className="mt-6">
                    <p className="text-lg leading-relaxed text-white">
                      ...
                      learned many things from the painting from here and I am recommended
